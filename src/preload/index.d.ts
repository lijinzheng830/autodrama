...
export interface Api {
  ...
  deleteParseGroup: (projectId: string, parseGroup: number) => Promise<void>
  ...
  autoProcessSeedance: (projectId: string, script: string, options?: AutoProcessOptions) => Promise<unknown>
