...
| 内心独白 | inner_monologue | `角色名的内心独白：内容` | 角色嘴巴闭合，表情/眼神传达情绪 | `林小薇的内心独白：为什么……我会觉得心脏在疼？` |
| 旁白 | narration | `旁白：内容` | 所有角色嘴巴闭合，画外音 | `旁白：夜幕降临，城市陷入了沉默。` |
...
### 字数硬约束（不满足视为不合格）
- **shot_description（中文画面描述）必须 ≥ 60 字**。具体到人/物/位置/姿态/表情/光影/氛围，让人读后脑中出画面。
- **shot_description_en（英文画面描述）必须 ≥ 50 词**。具体到 the specific person, object, position, posture, expression, lighting, atmosphere.

### 分镜节奏与数量硬约束
- 每段原文至少拆 3 个分镜。少于 3 个说明拆得太粗，必须重拆。
...
[
  {
    ...
    "dialogue": "",
    "inner_monologue": "林小薇的内心独白：台下这么多人……我能做到吗？",
    "narration": "",
    "shot_type": "全景",
    "camera_movement": "跟随",
