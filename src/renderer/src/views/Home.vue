...
const cardAccentColors = ['#5b6af0', '#f472b6', '#34d399', '#fbbf24', '#a78bfa', '#60a5fa']
...
<template>
  <div class="home-container">
    <header class="home-header">
      <h1 class="title">
        <span class="gradient-text">Endless Ideas</span>
    ...
    <main class="home-main">
      ...
      <div v-else class="project-grid">
        <!-- 项目卡片 -->
        <div v-for="(p, idx) in projects" :key="p.id" class="project-card" :style="{ background: 'linear-gradient(135deg, ' + cardAccentColors[idx % cardAccentColors.length] + '44 0%, ' + cardAccentColors[idx % cardAccentColors.length] + '11 60%, rgba(255,255,255,0.02) 100%)', borderLeftColor: cardAccentColors[idx % cardAccentColors.length] }" @click="openProject(p.id)">
...
.home-container {
  ...
  background: radial-gradient(circle at 50% 45%, rgba(15,15,17,0) 0%, rgba(15,15,17,0) 25%, rgba(15,15,17,0.25) 50%, rgba(15,15,17,0.7) 100%), url(/bg-home.png) center / contain no-repeat;
}
...
.gradient-text {
  background: linear-gradient(90deg, #4da8ff, #8ecfff);
